...
#define HDPATH_0_DEFAULT     (0x80000000u | 44u)
#define HDPATH_1_DEFAULT     (0x80000000u | 60u)
...
#define MENU_MAIN_APP_LINE1                "XPLA"
#define MENU_MAIN_APP_LINE2                "Ready"
#define APPVERSION_LINE1                   "Version:"
#define APPVERSION_LINE2                   ("v" APPVERSION)

#define COIN_DEFAULT_CHAINID               "dimension_37-1"

// In non-expert mode, the app will convert from axpla to XPLA
#define COIN_DEFAULT_DENOM_BASE            "axpla"
#define COIN_DEFAULT_DENOM_REPR            "XPLA"
#define COIN_DEFAULT_DENOM_FACTOR           18
#define COIN_DEFAULT_DENOM_TRIMMING         3
