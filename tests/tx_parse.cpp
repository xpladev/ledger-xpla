...
#pragma clang diagnostic pop
    ...
    TEST(TxParse, Tx_Page_Count) {
        auto transaction = R"({"account_number":"0","chain_id":"test-chain-1","fee":{"amount":[{"amount":"5","denom":"axpla"}],"gas":"10000"},"memo":"testmemo","msgs":[{"inputs":[{"address":"xplaaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"axpla"}]}],"outputs":[{"address":"xplaaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"axpla"}]}]}],"sequence":"1"})";
    ...
    TEST(TxParse, Page_Count_MultipleMsgs) {
        auto transaction =
                R"({"account_number":"0","chain_id":"test-chain-1","fee":{"amount":[{"amount":"5","denom":"axpla"}],"gas":"10000"},"memo":"testmemo","msgs":[{"inputs":[{"address":"xplaaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"axpla"}]}],"outputs":[{"address":"xplaaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"axpla"}]}]},{"inputs":[{"address":"xplaaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"axpla"}]}],"outputs":[{"address":"xplaaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"axpla"}]}]},{"inputs":[{"address":"xplaaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"axpla"}]}],"outputs":[{"address":"xplaaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"axpla"}]}]},{"inputs":[{"address":"xplaaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"axpla"}]}],"outputs":[{"address":"xplaaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"axpla"}]}]}],"sequence":"1"})";
