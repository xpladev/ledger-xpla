...
This project contains the XPLA app for Ledger Nano S and X.

- Ledger Nano S/X XPLA app
- Specs / Documentation
- C++ unit tests
- Zemu tests
...
Download a release from here (https://github.com/xpladev/ledger-xpla/releases). You only need `zxtool.sh`
