...
namespace {
    ...
    TEST(MACROS, bip44path1) {
        ...
        EXPECT_EQ("44/60/0/0/0", std::string(buffer));
    }

    TEST(MACROS, bip44path2) {
        uint32_t path[] = {0x8000002c, 60, 0, 0, 0};
    ...
    TEST(MACROS, bip44path3) {
        uint32_t path[] = {0x8000002c, 60, 0, 0, 0x80000000};
